...
def get_params():
    ...
    parser.add_argument('--auto-suc', dest='auto_successes', type=int, default=0)
    ...
    parser.add_argument('--auto-btch', dest='auto_botches', type=int, default=0)
    ...
    # Weird Options
    parser.add_argument('--botch-anyway', dest='botch_anyway', action='store_const', const=True)

    # Additional Options
    parser.add_argument('--no-sort', dest='no_sort', action='store_const', const=True)
